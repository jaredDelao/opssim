...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-components-not-logged-module"], {
  ...
  /***/
  function node_modulesNgxGalleryCoreFesm2015NgxGalleryCoreJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var filterActions = function filterActions(actions) {
      return Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["filter"])(function (state) {
      ...
      _createClass(GalleryRef, [{
        ...
        value: function activatePlayer() {
          ...
          return this.playerActions.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["switchMap"])(function (e) {
            return e.isPlaying ? Object(rxjs__WEBPACK_IMPORTED_MODULE_5__["of"])({}).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["delay"])(_this._config.value.playerInterval), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["tap"])(function () {
              return _this.next();
    ...
    var GALLERY_CONFIG = new _angular_core__WEBPACK_IMPORTED_MODULE_4__["InjectionToken"]('galleryConfig');
    /**
     * @fileoverview added by tsickle
     * @suppress {checkTypes,extraRequire,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    ...
    var Gallery = /*#__PURE__*/function () {
      ...
      _createClass(Gallery, [{
        ...
        value: function deleteInstance(id) {
          ...
          return function () {
            if (_this2._instances.has(id)) {
              _this2._instances["delete"](id);
            }
          };
        }
      }]);
    ...
    Gallery.ngInjectableDef = Object(_angular_core__WEBPACK_IMPORTED_MODULE_4__["defineInjectable"])({
      factory: function Gallery_Factory() {
        return new Gallery(Object(_angular_core__WEBPACK_IMPORTED_MODULE_4__["inject"])(GALLERY_CONFIG, 8));
      },
      token: Gallery,
      providedIn: "root"
    });
    ...
    var GalleryThumbsComponent = /*#__PURE__*/function () {
      ...
      function GalleryThumbsComponent(_el, _zone) {
        ...
        this._slidingWorker$ = new rxjs__WEBPACK_IMPORTED_MODULE_5__["BehaviorSubject"]({
          value: 0,
          active: false
        });
        /**
        ...
        this.error = new _angular_core__WEBPACK_IMPORTED_MODULE_4__["EventEmitter"](); // Activate sliding worker

        this.sliderState$ = this._slidingWorker$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(function (state) {
          return {
            style: _this4.getSliderStyles(state),
            active: state.active
          };
        }));
      }
        ...
        value: function ngOnInit() {
          ...
          if (this.config.gestures && !this.config.disableThumb && typeof Hammer !== 'undefined') {
            ...
            this._zone.runOutsideAngular(function () {
              // Move the slider
              switch (_this5.config.thumbMode) {
                case ThumbnailsMode.Strict:
                  _this5._hammer.on('pan', function (e) {
                    return _this5.strictMode(e);
                  });
    ...
    var GallerySliderComponent = /*#__PURE__*/function () {
      ...
      function GallerySliderComponent(_el, _zone, platform) {
        ...
        this.sliderState$ = this._slidingWorker$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(function (state) {
          return {
            style: _this6.getSliderStyles(state),
            active: state.active
          };
        }));
      }
      ...
      _createClass(GallerySliderComponent, [{
        ...
        value: function ngOnInit() {
          ...
          if (this.config.gestures && typeof Hammer !== 'undefined') {
            ...
            this._zone.runOutsideAngular(function () {
              // Move the slider
              _this7._hammer.on('pan', function (e) {
                switch (_this7.config.slidingDirection) {
          ...
          if (Object(_angular_common__WEBPACK_IMPORTED_MODULE_3__["isPlatformBrowser"])(this.platform)) {
            this._resizeSub$ = Object(rxjs__WEBPACK_IMPORTED_MODULE_5__["fromEvent"])(window, 'resize').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["debounceTime"])(200), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["tap"])(function () {
              return _this7.updateSlider(_this7._slidingWorker$.value);
            })).subscribe();
          }

          setTimeout(function () {
            return _this7.updateSlider({
              value: 0,
              active: false
            });
          });
    ...
    var LazyImage = /*#__PURE__*/function () {
      ...
      function LazyImage(document) {
        ...
        this.error = new _angular_core__WEBPACK_IMPORTED_MODULE_4__["EventEmitter"]();
        this._loaderSub$ = this._imageLoader$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["switchMap"])(function (imageSrc) {
          return _this8.nativeLoader(imageSrc);
        })).subscribe();
      }
      /**
       * @param {?} changes
      ...
      _createClass(LazyImage, [{
        ...
        value: function nativeLoader(url) {
          ...
          var loadSuccess = Object(rxjs__WEBPACK_IMPORTED_MODULE_5__["fromEvent"])(img, 'load').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["tap"])(function () {
            return _this9.loaded.emit(url);
          })); // Image load failed

          /** @type {?} */

          var loadError = Object(rxjs__WEBPACK_IMPORTED_MODULE_5__["fromEvent"])(img, 'error').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["tap"])(function () {
            return _this9.error.emit(new Error("[lazyImage]: The image ".concat(url, " did not load")));
          }));
        ...
        value: function activateClickEvent() {
          ...
          if (typeof Hammer !== 'undefined') {
            ...
            this._hammer.on('tap', function () {
              if (!_this10.tapClickDisabled) {
                _this10.tapClick.emit(null);
              }
            });
          } else {
            // Use normal click event
            this.clickListener = Object(rxjs__WEBPACK_IMPORTED_MODULE_5__["fromEvent"])(this._el.nativeElement, 'click').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["filter"])(function () {
              return !_this10.tapClickDisabled;
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["tap"])(function () {
              return _this10.tapClick.emit(null);
            })).subscribe();
          }
        }
        /**
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppPagesComponentsLoggedModalsSelectAddressModalSelectAddressModalComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppPagesComponentsCartCartComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppPagesComponentsCheckoutCheckoutComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppPagesComponentsHomeHomeComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppPagesComponentsMenuOcasionMenuOcasionComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppPagesComponentsProductDetailProductDetailComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppPagesComponentsProductsProductsComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppPagesComponentsTipsTipsComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppModelsOrderModelTs(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_require__.d(__webpack_exports__, "ItemCreateOrderCart", function () {
      return ItemCreateOrderCart;
    });
    /* harmony import */
    ...
    /*! tslib */
    "./node_modules/tslib/tslib.es6.js"); // Classes


    var CreateOrder = function CreateOrder(idDireccion, persona, total, itemCart) {
      _classCallCheck(this, CreateOrder);

      this.iIdDireccion = idDireccion;
      this.sPersonaRecibe = persona;
      this.dTotal = total;
      this.ItemsCart = itemCart.reduce(function (acc, x) {
    ...
    var ItemCreateOrderCart = function ItemCreateOrderCart(precioUnitario, idProducto, cantidad, precio, iva) {
      _classCallCheck(this, ItemCreateOrderCart);
  ...
  /***/
  function srcAppPagesComponentsLoggedModalsSelectAddressModalSelectAddressModalComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesComponentsLoggedModalsSelectAddressModalSelectAddressModalComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "SelectAddressModalComponent", function () {
      return SelectAddressModalComponent;
    });
    /* harmony import */
    ...
    var SelectAddressModalComponent = /*#__PURE__*/function () {
      function SelectAddressModalComponent(_addressService, dialogRef) {
        _classCallCheck(this, SelectAddressModalComponent);
      ...
      _createClass(SelectAddressModalComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          this.getAddress();
        }
        ...
        value: function getAddress() {
          ...
          this._addressService.getAddress().subscribe(function (resp) {
            if (resp.length > 0) {
              _this11.addressList = resp;
            }
          });
        }
      }]);
    ...
    SelectAddressModalComponent.ctorParameters = function () {
      return [{
    ...
    SelectAddressModalComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-select-address-modal',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./select-address-modal.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/@components-logged/@modals/select-address-modal/select-address-modal.component.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./select-address-modal.component.scss */
      "./src/app/pages/@components-logged/@modals/select-address-modal/select-address-modal.component.scss"))["default"]]
  ...
  /***/
  function srcAppPagesComponentsCartCartComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesComponentsCartCartComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var CartComponent = /*#__PURE__*/function () {
      function CartComponent(fb, _cartService) {
        ...
        this.itemsDummy = [{
          ...
          img: ['../../../../assets/images/demo/DonPedroGranRva600x800.jpg']
        }, {
          name: 'Azteca de Oro',
          category: 'Brandy',
          price: 200,
          stock: 1,
          description: 'description',
          img: ['../../../../assets/images/demo/azteca_oro_600x800.jpg']
        }, {
          ...
          stock: 1,
          description: 'description',
          img: ['../../../../assets/images/demo/botella3.jpg']
        }, {
          name: 'Jack Daniels',
          category: 'Whiskey',
          price: 300,
          stock: 1,
          description: 'description',
          img: ['../../../../assets/images/demo/botella4.jpg']
        }];
      ...
      _createClass(CartComponent, [{
        ...
        key: "addSelectToForm",
        value: function addSelectToForm(i, value) {
          var control = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](value);
          this.form.setControl("controlItem".concat(i), control);
        }
      }, {
        key: "getCounter",
        ...
        value: function getItems() {
          ...
          this._cartService.getItems().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["takeUntil"])(this.$unsubscribe)).subscribe(function (items) {
            items.forEach(function (v, i) {
              _this12.addSelectToForm(i, v.quantity);
            });
          });
        }
      }, {
        key: "updateQuantity",
        value: function updateQuantity(item, quantity) {
          quantity = Number(quantity);

          var resp = this._cartService.setQuantityItem(item, quantity);
        } // Remove cart items

      }, {
        key: "removeItem",
        value: function removeItem(item, i) {
          this._cartService.removeFromCart(item);

          console.log(this.form);
          this.form.removeControl("controlItem".concat(i));
        }
      }, {
        key: "deleteItem",
    ...
    CartComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/@components/cart/cart.component.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./cart.component.scss */
      "./src/app/pages/@components/cart/cart.component.scss"))["default"]]
    })], CartComponent);
    /***/
  },
  ...
  /***/
  function srcAppPagesComponentsCheckoutCheckoutComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesComponentsCheckoutCheckoutComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var src_app_services_address_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! src/app/services/address.service */
    "./src/app/services/address.service.ts");
    /* harmony import */
    ...
    var _components_logged_modals_select_address_modal_select_address_modal_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! ../../@components-logged/@modals/select-address-modal/select-address-modal.component */
    "./src/app/pages/@components-logged/@modals/select-address-modal/select-address-modal.component.ts");

    var CheckoutComponent = /*#__PURE__*/function () {
      function CheckoutComponent(fb, _cartService, _orderService, _addressService, dialog) {
      ...
      _createClass(CheckoutComponent, [{
        ...
        value: function ngOnInit() {
          this.formInit();
          this.getAddressDefault(); // this._wishlistService.addWishlist('1').subscribe(console.log)
        }
      }, {
        key: "formInit",
        value: function formInit() {
              ...
              while (1) {
                switch (_context.prev = _context.next) {
                  ...
                  case 2:
                    ...
                    this._cartService.getTotalAmount().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])(function (total) {
                      var order = new src_app_models_order_model__WEBPACK_IMPORTED_MODULE_4__["CreateOrder"](1, 'José', total, products);
                      var base64 = btoa(JSON.stringify(order));
                      return _this13._orderService.createOrder(base64);
        ...
        key: "getAddressDefault",
        value: function getAddressDefault() {
          var _this14 = this;

          this._addressService.getAddress().subscribe(function (resp) {
            if (resp.length > 0) {
              _this14.addressDefault = resp[0];
            }
          });
        }
      }, {
        ...
        value: function openDialog() {
          ...
          var dialogRef = this.dialog.open(_components_logged_modals_select_address_modal_select_address_modal_component__WEBPACK_IMPORTED_MODULE_9__["SelectAddressModalComponent"], {
            maxWidth: '700px',
            disableClose: true
          });
          dialogRef.afterClosed().subscribe(function (result) {
            _this15.idAddress = result;
          });
        }
      }, {
        key: "getProducts",
    ...
    CheckoutComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/@components/checkout/checkout.component.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./checkout.component.scss */
      "./src/app/pages/@components/checkout/checkout.component.scss"))["default"]]
    })], CheckoutComponent);
    /***/
  },
  ...
  /***/
  function srcAppPagesComponentsHomeHomeComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesComponentsHomeHomeComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    HomeComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/@components/home/home.component.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./home.component.scss */
      "./src/app/pages/@components/home/home.component.scss"))["default"]]
    })], HomeComponent);
    /***/
  },
  ...
  /***/
  function srcAppPagesComponentsMenuOcasionMenuOcasionComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesComponentsMenuOcasionMenuOcasionComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "MenuOcasionComponent", function () {
      return MenuOcasionComponent;
    });
    /* harmony import */
    ...
    var MenuOcasionComponent = /*#__PURE__*/function () {
      function MenuOcasionComponent() {
        _classCallCheck(this, MenuOcasionComponent);
      }

      _createClass(MenuOcasionComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }]);
    ...
    MenuOcasionComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-menu-ocasion',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./menu-ocasion.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/@components/menu-ocasion/menu-ocasion.component.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./menu-ocasion.component.scss */
      "./src/app/pages/@components/menu-ocasion/menu-ocasion.component.scss"))["default"]]
  ...
  /***/
  function srcAppPagesComponentsNotLoggedRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "NotLoggedRoutingModule", function () {
      return NotLoggedRoutingModule;
    });
    /* harmony import */
    ...
    var src_app_shared_modals_signup_signup_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! src/app/shared/@modals/signup/signup.component */
    "./src/app/shared/@modals/signup/signup.component.ts");
    /* harmony import */


    var _menu_ocasion_menu_ocasion_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./menu-ocasion/menu-ocasion.component */
    "./src/app/pages/@components/menu-ocasion/menu-ocasion.component.ts");
    /* harmony import */
    ...
    var _tips_tips_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    /*! ./tips/tips.component */
    ...
    var routes = [{
      ...
      path: 'registro',
      component: src_app_shared_modals_signup_signup_component__WEBPACK_IMPORTED_MODULE_7__["SignupComponent"]
    }, {
      path: 'products/:idTipo/:idCategory',
      ...
      path: 'menu-ocasion',
      component: _menu_ocasion_menu_ocasion_component__WEBPACK_IMPORTED_MODULE_8__["MenuOcasionComponent"]
    }, {
      path: 'tips',
      component: _tips_tips_component__WEBPACK_IMPORTED_MODULE_10__["TipsComponent"]
    }];

    var NotLoggedRoutingModule = function NotLoggedRoutingModule() {
      _classCallCheck(this, NotLoggedRoutingModule);
    };

    NotLoggedRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  /***/
  function srcAppPagesComponentsNotLoggedModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "NotLoggedModule", function () {
      return NotLoggedModule;
    });
    /* harmony import */
    ...
    var _not_logged_routing_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./not-logged-routing.module */
    "./src/app/pages/@components/not-logged-routing.module.ts");
    /* harmony import */
    ...
    var _ngx_gallery_core__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    /*! @ngx-gallery/core */
    "./node_modules/@ngx-gallery/core/fesm2015/ngx-gallery-core.js");
    /* harmony import */
    ...
    var src_app_shared_modals_modals_module__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
    /*! src/app/shared/@modals/modals.module */
    "./src/app/shared/@modals/modals.module.ts");
    /* harmony import */


    var _menu_ocasion_menu_ocasion_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
    /*! ./menu-ocasion/menu-ocasion.component */
    "./src/app/pages/@components/menu-ocasion/menu-ocasion.component.ts");
    /* harmony import */
    ...
    var _components_logged_modals_select_address_modal_select_address_modal_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(
    /*! ../@components-logged/@modals/select-address-modal/select-address-modal.component */
    "./src/app/pages/@components-logged/@modals/select-address-modal/select-address-modal.component.ts");
    /* harmony import */


    var _tips_tips_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
    /*! ./tips/tips.component */
    "./src/app/pages/@components/tips/tips.component.ts");

    var modals = [_components_logged_modals_select_address_modal_select_address_modal_component__WEBPACK_IMPORTED_MODULE_16__["SelectAddressModalComponent"]];

    var NotLoggedModule = function NotLoggedModule() {
      _classCallCheck(this, NotLoggedModule);
    };

    NotLoggedModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      declarations: [_home_home_component__WEBPACK_IMPORTED_MODULE_4__["HomeComponent"], _product_detail_product_detail_component__WEBPACK_IMPORTED_MODULE_5__["ProductDetailComponent"], _cart_cart_component__WEBPACK_IMPORTED_MODULE_6__["CartComponent"], _checkout_checkout_component__WEBPACK_IMPORTED_MODULE_7__["CheckoutComponent"], _menu_ocasion_menu_ocasion_component__WEBPACK_IMPORTED_MODULE_13__["MenuOcasionComponent"], _products_products_component__WEBPACK_IMPORTED_MODULE_15__["ProductsComponent"], _components_logged_modals_select_address_modal_select_address_modal_component__WEBPACK_IMPORTED_MODULE_16__["SelectAddressModalComponent"], _tips_tips_component__WEBPACK_IMPORTED_MODULE_17__["TipsComponent"]],
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _not_logged_routing_module__WEBPACK_IMPORTED_MODULE_3__["NotLoggedRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_9__["ReactiveFormsModule"], src_app_material_module__WEBPACK_IMPORTED_MODULE_8__["MaterialModule"], _ngx_gallery_core__WEBPACK_IMPORTED_MODULE_10__["GalleryModule"], ngx_owl_carousel_o__WEBPACK_IMPORTED_MODULE_11__["CarouselModule"], src_app_shared_modals_modals_module__WEBPACK_IMPORTED_MODULE_12__["ModalsModule"], src_app_shared_shared_module__WEBPACK_IMPORTED_MODULE_14__["SharedModule"]],
  ...
  /***/
  function srcAppPagesComponentsProductDetailProductDetailComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesComponentsProductDetailProductDetailComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var ProductDetailComponent = /*#__PURE__*/function () {
      function ProductDetailComponent(productsService, activatedRoute) {
        ...
        this.slidesStore = [{
          id: '1',
          src: '../../../../assets/images/demo/DonPedroGranRva600x800.jpg'
        }, {
          id: '2',
          src: '../../../../assets/images/demo/azteca_oro_600x800.jpg'
        }, {
          id: '3',
          src: '../../../../assets/images/demo/botella3.jpg'
        }, {
          id: '4',
          src: '../../../../assets/images/demo/botella4.jpg'
        }, {
          id: '5',
          src: '../../../../assets/images/demo/botella1.jpg'
        }, {
          id: '6',
          src: '../../../../assets/images/demo/botella2.jpg'
        }, {
          id: '7',
          src: '../../../../assets/images/demo/botella3.jpg'
        }, {
      ...
      _createClass(ProductDetailComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.activatedRoute.params.subscribe(function (params) {
            _this16.getProductById(params.idProduct);
          });
        }
      }, {
        key: "getProductById",
        value: function getProductById(id) {
          ...
          this.productsService.getProductById(id).subscribe(function (resp) {
            console.log(resp[0]);

            if (resp.length > 0) {
              _this17.product = resp[0];

              _this17.setImagesProduct(resp[0].sUrlImagenes);
            }
        ...
        key: "setImagesProduct",
        value: function setImagesProduct(imagesProduct) {
          debugger;
          this.images = imagesProduct.reduce(function (acc, image) {
            acc.push(new _ngx_gallery_core__WEBPACK_IMPORTED_MODULE_2__["ImageItem"]({
              src: image,
              thumb: image
            }));
            return acc;
    ...
    ProductDetailComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/@components/product-detail/product-detail.component.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./product-detail.component.scss */
      "./src/app/pages/@components/product-detail/product-detail.component.scss"))["default"]]
  ...
  /***/
  function srcAppPagesComponentsProductsProductsComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesComponentsProductsProductsComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var ProductsComponent = /*#__PURE__*/function () {
      function ProductsComponent(cartService, productsService, activatedRoute, router) {
        _classCallCheck(this, ProductsComponent);

        this.cartService = cartService;
        this.productsService = productsService;
        this.activatedRoute = activatedRoute;
        this.router = router; // Lists
      ...
      _createClass(ProductsComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.activatedRoute.params.subscribe(function (params) {
            _this18.getProducts(params.idTipo, params.idCategory);
          });
        }
      }, {
        key: "ngOnDestroy",
        ...
        key: "getProducts",
        value: function getProducts(idTipo, idCategory) {
          var _this19 = this;

          this.productsService.getProductsByTipoAndByCategory(idTipo, idCategory).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["takeUntil"])(this.$subscription)).subscribe(function (resp) {
            _this19.productosList = resp;
          });
        }
      }, {
        key: "verProducto",
        value: function verProducto(id) {
        ...
        value: function addToCart(cartItem) {
          ...
          var cart = this.cartService.addToCart(cartItem, quantity);
          console.log(cart);
        }
      }]);
    ...
    ProductsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/@components/products/products.component.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./products.component.scss */
      "./src/app/pages/@components/products/products.component.scss"))["default"]]
    })], ProductsComponent);
    /***/
  },
  ...
  /***/
  function srcAppPagesComponentsTipsTipsComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesComponentsTipsTipsComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "TipsComponent", function () {
    ...
    var TipsComponent = /*#__PURE__*/function () {
      function TipsComponent() {
        _classCallCheck(this, TipsComponent);
      }

      _createClass(TipsComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }]);
    ...
    TipsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-tips',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./tips.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/@components/tips/tips.component.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./tips.component.scss */
      "./src/app/pages/@components/tips/tips.component.scss"))["default"]]
    })], TipsComponent);
    /***/
  }
}]);
//# sourceMappingURL=pages-components-not-logged-module-es5.js.map